package com.ssafy.honjaya.listener;
...
public class WebSocketEventListener {
	...
	public void handleWebSocketConnectListener(SessionConnectedEvent event) {
		 ...
		 * System.out.println("## headerAccessor :: " + headerAccessor); String
		 * chatRoomId = headerAccessor.getNativeHeader("chatRoomId").get(0); String
		 * sessionId = headerAccessor.getSessionId();
		 */

		logger.info("[Connected] room id : {} | websocket session id : {}", chatRoomId, sessionId);

		meetingService.connectUser(chatRoomId, sessionId);
	}
	...
	public void handleWebSocketDisconnectListener(SessionDisconnectEvent event) {
		...
		meetingService.disconnectUser(sessionId);
	}
}
